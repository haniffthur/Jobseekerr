    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-outline-primary btn-sm mr-1" type="button" title="Detail" data-toggle="modal" data-target="#detailAdminPesanModal-{{ $hubungi->id }}">
                                               <i class="fas fa-eye"></i>
                                            </button>
                                            
                                            <form action="{{ route ('adminpesan.destroy', $hubungi->nama) }}" method="post" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button class="btn btn-outline-danger btn-sm" type="button" title="Hapus" onclick="confirmDelete({{ $hubungi->id }})">
                ...
                <!-- /.container-fluid -->
            <!-- Modal Detail Pesan -->
            <div class="modal fade" id="detailAdminPesanModal-{{ $hubungi->id }}" tabindex="-1" role="dialog" aria-labelledby="detailAdminPesanModalLabel-{{ $hubungi->id }}" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="detailAdminPesanModalLabel-{{ $hubungi->id }}">Detail Pesan</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $hubungi->nama }}" disabled>
                            </div>
                            <div class="form-group">
                                <label>Email Pengirim:</label>
                                <input type="email" class="form-control" value="{{ $hubungi->email }}" disabled>
                            </div>
                            <div class="form-group">
                                <label>Pesan:</label>
                                <textarea class="form-control" rows="5" disabled>{{ $hubungi->pesan }}</textarea>
                            </div>
                        </div>
